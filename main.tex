...
\hypersetup{
    ...
    filecolor=oxfordblue,
	  citecolor=oxfordblue,
    urlcolor=oxfordblue,
    pdftitle={Design and modular self-assembly of nanostructures}
}
...
Ellen \includegraphics[height=1em]{figures/ulsk.eps}\\
...
\include{text/ch-polycubes_intro}
\include{text/ch-polycubes1}
\include{text/ch-polycubes2}
\include{text/ch-oxView_intro}
\include{text/ch-oxView}
\include{text/ch-conclusion}
