...
\begin{figure}[h]
  \begin{center}
    \begin{overpic}[width=\textwidth]{figures/adenita.jpg}
      ...
      \put(-20,100){b)}
    \end{overpic}
    \caption{Adenita, adapted from \cite{miao_tvcg_2018}. a) A DNA double-helix visualised at different abstraction levels, with a purple band highlihghting a specific base-pair at all the four main levels. b) Available editing and visualisation tools in Adenita.}
    \label{fig:adenita}
  \end{center}
\end{figure}
