...
Another option for oxView dynamics is to use oxServe, an server developed mainly by Michael Matthies that connects oxView to an oxDNA instance using websockets. By first relaxing the clusters and then using oxServe to relax the structure on a nucleotide level, users can interactively perform the full relaxation process from oxView.
