...
\paragraph{Centring with periodic boundary conditions.} A useful utility when visualising an oxDNA trajectory is to keep the structure centered at the origin, stopping it from drifting out of view. The method described in \cite{PBC_centring} was used to achieve centering while taking periodic boundary contitions into account.
